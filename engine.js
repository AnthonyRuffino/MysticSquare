...
var BOARD_SIZE_PERCENTAGE = 0.5;
var DEBUG = true;

var renderer = new Renderer(window, document, "dippee", BOARD_SIZE_PERCENTAGE);
renderer.init();
PROFESSING.renderer = renderer;

var driver = {};
driver.renderer = renderer;
driver.controlsBinding = document;
driver.log = window.console.log;
driver.alert = (txt) => { alert.call(window, txt); };
PROFESSING.driver = driver;
